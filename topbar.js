...
// It self-injects HTML + CSS: a top-right finance shortcut, and
// the Main/Study/Fitness bottom tabs. Skips chrome on finance.html
// and inside iframes (so embedded pages can render standalone).
// =============================================================
(function () {
  'use strict';
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Main tabs">
  ...
  <a href="health.html" class="bottombar-tab" data-page="study">
  ...
  <a href="journal.html" class="bottombar-tab" data-page="journal">
    <span class="bottombar-tab-icon">📓</span><span>Journal</span>
  </a>
</nav>`;
  ...
  function currentPageKey() {
    const p = (window.location.pathname || '').toLowerCase();
    if (p.endsWith('health.html')) return 'study';
